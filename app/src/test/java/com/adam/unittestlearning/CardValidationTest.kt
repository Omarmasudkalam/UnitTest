...
//    fun bankMatchesCardInitialSuccess() {
    ...
    @Test
    fun `match input date with card details- success` (){
        val alfaBank: String = "1234-1222-1112-1216"
        val validDate: Boolean= cardValidation!!.verifyDate(alfaBank)
        assertTrue(validDate)
    }

    @Test
    fun `match input date with card details- failure` (){
        val alfaBank: String = "1234-1222-1112-1216"
        val betaBank: String="3242-1222-1112-1216"
        val validWrongDate: Boolean= cardValidation!!.verifyWrongDate(alfaBank)

        assertFalse(validWrongDate)
    }

    @Test
//    fun CardDetailsMatchesSuccess() {
    fun `match the card details to check - success`() {
    }

    @Test
    fun `match the card details to check - failure`() {
